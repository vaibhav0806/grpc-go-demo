...
type GreetServiceClient interface {
	...
	SayHelloClientStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[NamesList, MessagesList], error)
...
func (c *greetServiceClient) SayHelloClientStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[NamesList, MessagesList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[NamesList, MessagesList]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClientStreamingClient = grpc.ClientStreamingClient[NamesList, MessagesList]
...
type GreetServiceServer interface {
	...
	SayHelloClientStreaming(grpc.ClientStreamingServer[NamesList, MessagesList]) error
...
func (UnimplementedGreetServiceServer) SayHelloClientStreaming(grpc.ClientStreamingServer[NamesList, MessagesList]) error {
...
func _GreetService_SayHelloClientStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloClientStreaming(&grpc.GenericServerStream[NamesList, MessagesList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClientStreamingServer = grpc.ClientStreamingServer[NamesList, MessagesList]
